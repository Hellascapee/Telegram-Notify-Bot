...
def callback_worker(call):
	if call.data == 'hour':
		...
		keyboard = types.InlineKeyboardMarkup()
		key_20min = types.InlineKeyboardButton(text='20 минут', callback_data='1')
		keyboard.add(key_20min)
		key_30min = types.InlineKeyboardButton(text='30 минут', callback_data='2')
		keyboard.add(key_30min)
		key_45min = types.InlineKeyboardButton(text='45 минут', callback_data='3')
		keyboard.add(key_45min)
		bot.send_message(call.message.chat.id, text="Выбраны минут", reply_markup=keyboard)
